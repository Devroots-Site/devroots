...
Um Python auf Ihrem Computer zu installieren, gehen Sie auf die [Python-Website](https://www.python.org/) und laden Sie die neueste Version von Python herunter. Folgen Sie den Anweisungen auf der Website, um Python auf Ihrem Computer zu installieren.
...
Um Python-Code zu schreiben, können Sie einen Texteditor wie Notepad oder einen integrierten Entwicklungsumgebung (IDE) wie PyCharm verwenden. Schreiben Sie Ihren Code in eine Datei mit der Erweiterung `.py` und führen Sie ihn aus, indem Sie `python dateiname.py` in Ihrer Befehlszeile eingeben.
