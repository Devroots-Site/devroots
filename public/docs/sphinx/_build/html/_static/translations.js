Documentation.addTranslations({
  ...
  messages: {
    ...
    'Automatically generated list of changes in version %(version)s':
      'Automatisch generierte Liste der \u00c4nderungen in Version %(version)s',
    ...
    'Last updated on %(last_updated)s.':
      'Zuletzt aktualisiert am %(last_updated)s.',
    ...
    "Your search did not match any documents. Please make sure that all words are spelled correctly and that you've selected enough categories.":
      'Ihre Suche ergab keine Treffer. Bitte stellen Sie sicher, dass alle W\u00f6rter richtig geschrieben sind und gen\u00fcgend Kategorien ausgew\u00e4hlt sind.',
    'all functions, classes, terms': 'alle Funktionen, Klassen, Begriffe',
    'can be huge': 'kann gro\u00df sein',
    'last updated': 'zuletzt aktualisiert',
    'lists all sections and subsections':
      'Liste aller Kapitel und Unterkapitel',
